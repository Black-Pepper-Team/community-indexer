...
GENERATED="${GOPATH}/src/github.com/black-pepper-team/community-indexer/resources"
OPENAPI_DIR="${GOPATH}/src/github.com/black-pepper-team/community-indexer/docs/web_deploy"
